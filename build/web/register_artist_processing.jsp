<%-- 
    Document   : register_artist_processing
    Created on : 11 20, 23, 12:02:01 AM
...
<html>
    <head>
        ...
        <title>Register Artist Processing</title>
    </head>
    <body>
            ...
            <%  
                ...
                int status = A.register_artist();
            
                if (status == 1){
            %>
            <h1>Artist Registered Successful</h1>
            <% } else {
            %>
            <h1>Artist Registered Failed</h1>
            <%     }
            %>
